-- ============================================================
-- Clavissimo – SQL Teil 3: BtM-Buch, Meldungen & Erlaubnis-Warnungen
-- Direkt im Supabase SQL-Editor des NEUEN Clavissimo-Projekts ausführen,
-- NACH 01_schema_clavis_basis.sql UND 02_medcang_integration.sql
-- (btm_buch referenziert die chargen-Tabelle aus 02).
-- ============================================================
